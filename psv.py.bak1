...
#    Sep 05, 2020 09:04:14 PM IST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.btnprint.place(relx=0.402, rely=0.179, height=34, width=107)
        ...
        self.labeltot = tk.Label(self.Frame3)
        self.labeltot.place(relx=0.802, rely=0.179, height=34, width=80)
        self.labeltot.configure(activebackground="#f9f9f9")
        self.labeltot.configure(activeforeground="black")
        self.labeltot.configure(background="#d9d9d9")
        self.labeltot.configure(disabledforeground="#a3a3a3")
        self.labeltot.configure(foreground="#000000")
        self.labeltot.configure(highlightbackground="#d9d9d9")
        self.labeltot.configure(highlightcolor="black")
        self.labeltot.configure(font="-family {Segoe UI} -size 10 -weight bold -slant roman -underline 0 -overstrike 0")
        self.labeltot.configure(text='''Total:''')

        self.labeltottxt = tk.Label(self.Frame3)
        self.labeltottxt.place(relx=0.880, rely=0.179, height=34, width=90)
        self.labeltottxt.configure(activebackground="#f9f9f9")
        self.labeltottxt.configure(activeforeground="black")
        ...
        self.labeltottxt.configure(highlightbackground="#d9d9d9")
        self.labeltottxt.configure(highlightcolor="black")
        self.labeltottxt.configure(font="-family {Segoe UI} -size 10 -weight bold -slant roman -underline 0 -overstrike 0")
        self.labeltottxt.configure(text='''0000.00''')
