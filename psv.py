...
#    Sep 07, 2020 12:29:57 PM IST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Label1_7.configure(text='''Make / Model''')
        ...
        self.lblkilometer = tk.Label(self.Frame2)
        self.lblkilometer.place(relx=0.683, rely=0.086, height=21, width=244)
        self.lblkilometer.configure(background="#d9d9d9")
        self.lblkilometer.configure(disabledforeground="#a3a3a3")
        self.lblkilometer.configure(foreground="#000000")
        self.lblkilometer.configure(text='''Kilo Meter''')

        self.txtkilometer = tk.Text(self.Frame2)
        self.txtkilometer.place(relx=0.671, rely=0.259, relheight=0.233
                , relwidth=0.316)
        self.txtkilometer.configure(background="white")
        self.txtkilometer.configure(font="TkTextFont")
        self.txtkilometer.configure(foreground="black")
        self.txtkilometer.configure(highlightbackground="#d9d9d9")
        self.txtkilometer.configure(highlightcolor="black")
        self.txtkilometer.configure(insertbackground="black")
        self.txtkilometer.configure(selectbackground="blue")
        self.txtkilometer.configure(selectforeground="white")
        self.txtkilometer.configure(wrap="word")
        ...
        self.btnprint.place(relx=0.311, rely=0.179, height=34, width=107)
        ...
        self.lbltotal = tk.Label(self.Frame3)
        self.lbltotal.place(relx=0.575, rely=0.357, height=21, width=84)
        self.lbltotal.configure(background="#d9d9d9")
        self.lbltotal.configure(disabledforeground="#a3a3a3")
        self.lbltotal.configure(font=font9)
        self.lbltotal.configure(foreground="#000000")
        self.lbltotal.configure(text='''Total''')

        self.labeltottxt = tk.Label(self.Frame3)
        self.labeltottxt.place(relx=0.778, rely=0.357, height=21, width=114)
        self.labeltottxt.configure(background="#d9d9d9")
        self.labeltottxt.configure(disabledforeground="#a3a3a3")
        self.labeltottxt.configure(font=font10)
        self.labeltottxt.configure(foreground="#000000")
        self.labeltottxt.configure(text='''Label''')
        ...
        self.cboitemtype.place(relx=0.132, rely=0.392, relheight=0.034
                , relwidth=0.111)
        self.value_list = ['Material','Labour']
