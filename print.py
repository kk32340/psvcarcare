...
class Window(QMainWindow):
    ...
    def CreateMenu(self):
        ...
        printAction = QAction(QIcon("image\print.png"), "Print", self)
        printAction.triggered.connect(self.printDialog)
        fileMenu.addAction(printAction)
        printPreviewAction = QAction(QIcon("image\printprev.png"), "Print Preview", self)
        printPreviewAction.triggered.connect(self.printpreviewDialog)
        fileMenu.addAction(printPreviewAction)
        exportpdfAction = QAction(QIcon("image\pdf.png"), "Export PDF", self)
        exportpdfAction.triggered.connect(self.printPDF)
        fileMenu.addAction(exportpdfAction)
        exiteAction = QAction(QIcon("image\exit.png"), 'Exit', self)
        ...
        fontAction = QAction(QIcon("image\font.png"), "Font", self)
        fontAction.setShortcut("Ctrl+F")
        fontAction.triggered.connect(self.fontDialog)
        viewMenu.addAction(fontAction)
        colorAction = QAction(QIcon("image\color.png"), "Color", self)
